...
In that case, the feeling is the effect, and could be called empathy, a base animal instinct.
Empathy requires several components: 1) the presence of the instinct, 2) exposure to a trigger.
Exposure can easily be (and often is) bypassed or mitigated.
Empathy may have evolved as a low level subconscious implementation of a simple logical argument: What happens to others is more likely to happen to me, so it’s good for me when good things happen to others.
Other times, instead of empathy, the feedback mechanism might just be inanimate, like, “if I litter, others will see the litter and think it’s more ok to litter, and then I’ll have to deal with their litter.”
Even a sociopath can resonate with the ethical reasoning for not littering.
